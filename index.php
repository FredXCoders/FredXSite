			...
			<script type="text/javascript">
			  (function() {
				...
				var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
                            ...
                            <div class="col-lg-3">
          <h2>George Meadows</h2>
          <p>Dr. George Meadows, a Professor of Science & Makerspace-In-Education Pioneer within the College of Education at the University of Mary Washington, is passionate about introducing young people to the tools of scientific inquiry and engineering exploration, and works tirelessly to bring these advanced subjects to other educational leaders in our community.</p>
	    <!-- <p><a class="btn btn-default" href="#">Contact Us</a></p> -->
	  <p>
	  </p>
